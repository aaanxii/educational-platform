...
- Среднее кол-во категорий на пользователя по lifetime (среднее кол-во категорий, которые смотрит пользователь в зависимости от времени ухода пользователя)
...
- **`Custom metrics`**
<br> <img src="img/avg_cat.jpg" alt="Описание" width="500" height = "400">
<br> <img src="img/avg_pages.jpg" alt="Описание" width="500" height = "400">
