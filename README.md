...
- Среднее кол-во категорий на пользователя по lifetime (среднее кол-во категорий, которые посмотрел пользователь в зависимости от недели жизни пользователя).
- Доля пользователей за неделю, которые посмотрели все категории.
- Доля пользователей за неделю, которые посмотрели не менее 3х категорий.
- Доля пользователей, которые посмотрели 6 категорий за всё время, в зависимости от недели ухода пользователя.
- Доля пользователей, которые посмотрели 3 категорий за всё время, в зависимости от недели ухода пользователя.
...
- **`Lifetime`**
<br> За 7 недель жизни платформы средний Lifetime составил 1.6 недель, это достаточно мало, необходимо растить этот показатель.
...
- **`Custom metrics`**
  ...
  - `Cреднее кол-во категорий, которые посмотрел пользователь в зависимости от недели жизни пользователя`
