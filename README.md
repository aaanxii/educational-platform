...
<br> <br> <img src="img/dau.jpg" alt="Описание" width="700" height = "500">
<br> В конце марта был большой наплыв пользователей. Обычно старых пользователей в день заходят больше чем новых.

  - `Общий вывод`
  <br> WAU 10 недели было самое мальенькое, так как в эту неделю было 2 праздничных дня. В 12, 13 неделю пришло много новых пользователей, за счёт чего вырос MAU Марта, WAU и DAU 12, 13 недели.
