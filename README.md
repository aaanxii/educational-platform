...
- Среднее кол-во категорий на пользователя по lifetime (среднее кол-во категорий, которые посмотриел пользователь в зависимости от недели жизни пользователя)
...
- **`Retention`**
  - <img src="img/coh_ret.jpg" alt="Описание" width="500">  
  ...
  - <br> <img src="img/cat_ret_pt1.jpg" alt="Описание" width="1250" height = "300">
  ...
  - Общего падения retention в категориях не наблюдается, тем не менее в категориях course и trajectory последующие когорты показали себя хуже.
  - Retention 7 недели составляет всего 2%, что достаточно мало.
  - <br> <img src="img/retention.jpg" alt="Описание" width="500" height = "400">
...
<br> <img src="img/avg_pages.jpg" alt="Описание" width="500" height = "350">
<br> <img src="img/avg_cat_lifetime.jpg" alt="Описание" width="500" height = "350">
